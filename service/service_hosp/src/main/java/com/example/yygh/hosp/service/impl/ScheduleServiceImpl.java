...
import com.exmaple.yygh.vo.hosp.BookingScheduleRuleVo;
...
public class ScheduleServiceImpl implements ScheduleService {
    ...
    public void save(Map<String, Object> paramMap) {
        ...
        //判断是否存在
        Schedule scheduleExit = scheduleRepository.getScheduleByHoscodeAndHosScheduleId(schedule.getHoscode(),schedule.getDepcode());
